    ...
    return (
      <div className="group">
        <button
          ...
          {...props}
        >
          <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-teal-400 via-green-400 to-yellow-400 p-[2px] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
